...
namespace Gmina
{
    public class Program
    {
        ...
        private static void AddServices(WebApplicationBuilder builder)
        {
            ...
            string migrationsAssembly = typeof(Program).GetTypeInfo().Assembly.GetName().Name; //Gmina

            builder.Services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(connectionString, b => b.MigrationsAssembly("DAL")));

            //services.AddDbContext<RackPrivilegesContext>(options =>
            //options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"),
            //sql => sql.MigrationsAssembly("ITMCode.RackPrivileges.Dal")));
        ...
        private static void ConfigureRequestPipeline(WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - Gmina";
